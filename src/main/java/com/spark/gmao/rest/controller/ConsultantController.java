...
public class ConsultantController {
	...
	//afficher tt les consultants
		...
		@PostMapping("/consultants")/*/{type}*/
		public Object saveConsultant(@Valid @RequestBody ConsultantDto consultantDto /*@PathVariable String type*/) {
			...
			else if(type.equals("soustraitant")) {
				consultant = consultantService.saveConsultant(consultant);
			}*/
			consultant = consultantService.saveConsultant(consultant);
